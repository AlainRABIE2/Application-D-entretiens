...
function RegisterForm() {
    ...
    const handleSubmit = async (e)=>{
        ...
        const { data, error: signUpError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
            email,
            password
        });
        if (signUpError) {
        ...
        if (userId) {
            const { error: dbError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("Utilisateur").insert({
                auth_id: userId,
                nom,
                prenom,
                email
...
_s(RegisterForm, "wkVgUe78DqQO8hj/rggookNnaC8=", false, function() {
    return [
...
//# sourceMappingURL=_50aa5e40._.js.map